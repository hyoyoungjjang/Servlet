...
//		response.getWriter().print(age);
		 ...
		 * 
		 * {key:value, key:value...} => JSONObjext
...
//		response.getWriter().print(jobj);
		...
		list.add(new Member(1, "김효영", "01085890930"));
		list.add(new Member(2, "김효일", "01012345678"));
		list.add(new Member(3, "김효이", "00000000000"));
