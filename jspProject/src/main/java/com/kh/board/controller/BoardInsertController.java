...
//		String boardTitle = request.getParameter("title");
		...
		//enctype이 multipart/form-data로 잘 전송되어씅ㄹ겨웅 전반적인 내용이 실행되도록 코드 작성
		if(ServletFileUpload.isMultipartContent(request)) {
			 ...
			 * 
			 * 위 구문 한줄 실행만으로 넘어온 첨부파일이 해당폴더에 무조건 업로드 된다.
			 * 단, 업로드시 파일명을 수정해줘야한다. 그래서 파일명을 수정시켜주는 객체를 제시해야한다.
			 * => 같은 파일명이 있을경우 덮어씌어질 수 있고, 파일명에 한글/특수문자/띄어쓰기가 포함될 경우 서버에따라 문제발생
			 * 
			 ...
			 * }
			 * 
			 * 나만의 방식대로 절대 겹치지 않도록 rename 할수있게 FileRenamePolicy 클래스 만들기
