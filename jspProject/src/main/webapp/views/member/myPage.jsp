...
<body>
    ...
    <div class="outer">
        ...
        <form action="<%=contextPath%>/update.me" id="enroll-form" method="post">
            ...
            <br><br>
            <div align="center">
                <button type="submit" class="btn btn-sm btn-warning">정보변경</button>
                <button type="button" class="btn btn-primary btn-sm btn-secondary" data-toggle="modal" data-target="#update-pwd-modal">비밀번호변경</button>
