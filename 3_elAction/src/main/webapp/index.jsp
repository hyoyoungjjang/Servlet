...
<body>
	...
	<p>
		기존에 사용했던 표현식(출력식) &lt;= name &ge;와 같이 <br>
		JSP상에서 표현하고자하는 값을 \${name}의 형식으로 작성하는 것 
	</p>
	...
	<!-- 
	 ...
	 -->
	 <h3>* 표준액션태그(Standatd Action Tag)</h3>
	 ...
	 <h3> JSTL 선언방법</h3>
	 <p>
	 	JSTL을 사용하고자하는 해당 jsp페이지 상단아 <br>
	 	taglib 지시어를 사용해서 선언함 <br><br>
	 	
	 	&lt;%@ taglib prefix="접두어" uri="라이브러리 파일상의 uri주소" %gt;
	 </p>
	 ...
	 <a href="views/3_Custom_Action_tag/01_core.jsp">1. core</a>
	  ...
	  <p>숫자, 날짜 및 시간 데이터의 출력 형식을 저장할 때 사용하는 문법을 제공</p>
